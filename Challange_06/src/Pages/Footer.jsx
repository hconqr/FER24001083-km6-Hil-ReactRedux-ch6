...
const navigation = {
  ...
  social: [
    {
      name: "Instagram",
      href: "https://www.instagram.com/hyzimc_/",
      icon: (props) => (
    ...
    {
      name: "Linkedin",
      href: "https://www.linkedin.com/in/hilzi-maulana-conquero/",
      icon: (props) => (
        <svg
    ...
    <footer className="bg-gray-800 border-t border-gray-600">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        >
          {navigation.main.map((item) => (
            <div key={item.name} className="px-5 py-2">
              <a
                href={item.href}
                className="text-base text-white hover:text-red-500"
              >
                {item.name}
              </a>
            </div>
        ...
        <p className="mt-8 text-center text-base text-white">
          &copy; 2024 Movieku, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
